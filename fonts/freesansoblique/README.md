...
import (
  ...
  _ "github.com/gmlewis/go-fonts-f/fonts/freesansoblique"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from freesansoblique"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "freesansoblique", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
