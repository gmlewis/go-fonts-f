...
import (
  ...
  _ "github.com/gmlewis/go-fonts-f/fonts/freebooterscript"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from freebooterscript"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "freebooterscript", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
