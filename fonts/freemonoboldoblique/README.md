...
import (
  ...
  _ "github.com/gmlewis/go-fonts-f/fonts/freemonoboldoblique"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from freemonoboldoblique"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "freemonoboldoblique", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
